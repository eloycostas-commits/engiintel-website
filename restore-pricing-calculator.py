...
# Find the end of the pricing section (next tab or footer)
pricing_end = content.find('</div>\n\n\n<div id="resources"', pricing_start)
if pricing_end == -1:
    pricing_end = content.find('<footer>', pricing_start)

if pricing_end == -1:
    print("ERROR: Could not find end of pricing section")
    exit(1)

# New pricing section with calculator
new_pricing = '''<div id="pricing" class="tab-content">
...
print("✓ Restored pricing calculator")
